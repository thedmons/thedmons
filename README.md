...
| 🗂️ [PRD: Installation Services Lead Capture Widget](https://github.com/thedmons/prd-installation-services-widget) | Feature PRD for a configurable stepped-form widget consolidating 40+ installation service forms across 7 categories into a single adaptive experience — service type determination via API, Salesforce lead consolidation, dual standalone and embedded configuration modes. Discovery complete; deprioritized ahead of platform migration | E-Commerce |
